...
import emfitness.screens.PlanningModal;
import emfitness.utilities.Constants;
import emfitness.utilities.MaiFunctionCall;
import emfitness.utilities.MaiState;
import emfitness.utilities.MaiUtils;
import emfitness.utilities.MaiUtils.MaiComboxBoxCell;
...
public final class PlanningModalController {
    ...
    public PlanningModalController(final JFrame parent, final MaiFetch fetch, final MaiFunctionCall functionCall, final MaiState maiState,String roomId) {
        this.fetch = fetch;
    ...
    public PlanningModalController(final JFrame parent, final MaiFetch fetch, final String planningId,
            ...
            final String activity, final String roomName, MaiFunctionCall functionCall, final MaiState maiState,final String roomId) {
        this.fetch = fetch;
        this.maiState = maiState;
        this.roomId=roomId;
        planningModal = new PlanningModal(parent, true);
