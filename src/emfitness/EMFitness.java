...
import emfitness.components.MaiSplashScreen;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (var i = 0; i <= 100; i++) {
                ...
                var delay = Math.round(Math.random() * 50);
                try {
                    Thread.sleep(delay);
...
//                                                    ImageIO.read(new File(Constants.ICONS_PATH+"emf50x50.png")));
                                ...
                                () -> {
                                    try {
                                        ...
                                        Logger.getLogger(EMFitness.class.getName()).log(Level.SEVERE,e.getMessage());
                                    }
            ...
            Logger.getLogger(EMFitness.class.getName()).log(Level.SEVERE, null, ex);
        }
